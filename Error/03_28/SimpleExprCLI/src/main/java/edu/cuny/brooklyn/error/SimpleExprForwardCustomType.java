...
public class SimpleExprForwardCustomType {
	...
	public static int expr(int d1, int d2, String operator) throws ArithmeticException, IllegalArgumentException {
		...
		case "/":
			try {
				...
				throw  new SimpleExprException("Attempt to evaluate " + d1 + "/" + d2);
			}
			break;
		default:
			throw new SimpleExprException("Operator " + operator + " is not supported.");
		}
		return result;
	}
}
