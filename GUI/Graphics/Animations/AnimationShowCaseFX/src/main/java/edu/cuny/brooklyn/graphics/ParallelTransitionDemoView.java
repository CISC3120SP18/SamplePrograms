...
public class ParallelTransitionDemoView extends BaseView {

	public ParallelTransitionDemoView() {
		...
		button.setOnAction(e -> startParallelTransition(node));
	}

	private void startParallelTransition(Node node) {
		...
		ParallelTransition pt = new ParallelTransition(node, ft, tt, rt, st);
		pt.play();
	}
