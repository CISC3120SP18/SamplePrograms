...
public class UdpKnockKnock1stCLI {
	private final static Logger LOGGER = LoggerFactory.getLogger(UdpKnockKnock1stCLI.class);
	...
	public static void main(String[] args) {
		...
		try {
			address = new InetSocketAddress(InetAddress.getByName(localAddress), localPort);
