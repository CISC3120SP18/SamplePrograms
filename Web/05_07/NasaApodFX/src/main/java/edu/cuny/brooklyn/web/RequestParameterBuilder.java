...
public class RequestParameterBuilder {
	...
	public RequestParameterBuilder add(String name, boolean highResolution) throws UnsupportedEncodingException {
		String encodedName = URLEncoder.encode(name, StandardCharsets.UTF_8.name());
		if (highResolution) {
			parameterMap.put(encodedName, "True");
		} else {
			parameterMap.put(encodedName, "False");
		}
		return this;
	}
