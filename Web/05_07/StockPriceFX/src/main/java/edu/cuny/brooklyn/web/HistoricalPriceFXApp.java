...
public class HistoricalPriceFXApp extends Application {
	private final static Logger LOGGER = LoggerFactory.getLogger(HistoricalPriceFXApp.class);
	...
	public void start(Stage primaryStage) throws Exception {
		...
		HistoricalSharePriceService service = new HistoricalSharePriceService(apiKey); 
